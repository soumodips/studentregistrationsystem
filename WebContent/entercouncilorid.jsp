...
<form action="getcouncilordetail.jsp" method="post">

<table cellpadding="4px" cellspacing="3px">

<tr><td>Enter councillor ID:</td><td><input type="text" name="councilorid"></td></tr>

<tr><td></td><td><input type="submit" value="Get detail"></td></tr>
