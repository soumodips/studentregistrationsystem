...
<%
String cid=request.getParameter("councilorid");
int id=Integer.parseInt(cid.trim());
CouncilorDao cd=new CouncilorDao();
CouncilorBean cb=cd.getCouncilor(id);
if(cb!=null)
{%>

<table cellpadding="1" cellspacing="5" align="center">

<tr><th>ID</th><th>Name</th><th>Address</th><th>Contact number</th><th>Email</th><th>Password</th><th>Student count</th><th></th></tr>
